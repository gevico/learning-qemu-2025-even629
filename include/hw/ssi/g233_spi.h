...
#define G233_CR1_SPE_MASK   (1<<6) 
// 主模式选择位 0: 从模式 1: 主模式
#define G233_CR1_MSTR_MASK  (1<<2) 

/* CR2 interrupt bits */
// TXE 中断使能位 0: TXE 中断禁用 1: TXE 中断使能
#define G233_CR2_TXEIE_MASK (1 << 7) 
// RXNE 中断使能位 0: RXNE 中断禁用 1: RXNE 中断使能
#define G233_CR2_RXNEIE_MASK (1 << 6) 
// 错误中断使能位 0: 错误中断禁用 1: 错误中断使能
#define G233_CR2_ERRIE_MASK (1 << 5) 
// 软件从设备选择输出使能 0: SS 输出禁用 1: SS 输出使能
#define G233_CR2_SSOE_MASK (1 << 4) 

/* SR bits */
// 忙标志位 0: SPI 空闲 1: SPI 忙
#define G233_SR_BSY_MASK (1 << 7) 
// 溢出错误标志 0: 无溢出 1: 发生溢出(写 1 清除)
#define G233_SR_OVERRUN_MASK (1 << 3) 
// 下溢错误标志 0: 无下溢 1: 发生下溢（写 1 清除）
#define G233_SR_UNDERRUN_MASK (1 << 2)
// 发送缓冲区空标志 0: 发送缓冲区满 1: 发送缓冲区空
#define G233_SR_TXE_MASK (1 << 1) 
// 接收缓冲区非空标志 0: 接收缓冲区为空 1: 接收缓冲区非空，数据可读
#define G233_SR_RXNE_MASK (1 << 0) 

/* DR */
// 数据位 写入：发送数据 读取：接收数据
#define G233_DR_DATA_MASK (0xff) 

/* CSCTRL */
//CS3 激活状态 0: 非激活 1: 激活
#define G233_CSCTRL_CS3_ACT_MASK (1 << 7) 
//CS2 激活状态 0: 非激活 1: 激活
#define G233_CSCTRL_CS2_ACT_MASK (1 << 6) 
//CS1 激活状态 0: 非激活 1: 激活
#define G233_CSCTRL_CS1_ACT_MASK (1 << 5) 
//CS0 激活状态 0: 非激活 1: 激活
#define G233_CSCTRL_CS0_ACT_MASK (1 << 4) 

//CS3 使能位 0: 禁用 1: 使能
#define G233_CSCTRL_CS3_EN_MASK (1 << 3) 
//CS2 使能位 0: 禁用 1: 使能
#define G233_CSCTRL_CS2_EN_MASK (1 << 2) 
//CS1 使能位 0: 禁用 1: 使能
#define G233_CSCTRL_CS1_EN_MASK (1 << 1) 
//CS0 使能位 0: 禁用 1: 使能
#define G233_CSCTRL_CS0_EN_MASK 1 
